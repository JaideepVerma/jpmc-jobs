...
def normalize_fields(fields: Dict[str, Any]) -> Dict[str, Any]:
    ...
    record = {
        ...
        "company": simple.get("companyName"),
        ...
        "location_display": simple.get("normalizedLocation") or simple.get("location"),
        "short_description": strip_html(simple.get("shortDescription")),
        "description_text": strip_html(simple.get("description")),
        "basic_qualifications": strip_html(simple.get("basicQualifications")),
        ...
        "icimsJobId" : 'https://amazon.jobs/en/jobs/' + simple.get("icimsJobId")
    }
